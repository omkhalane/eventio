...
export const MOCK_EVENTS: CalendarEvent[] = [
  {
    ...
    platform: 'codeforces',
    external_id: '930',
    start_time: setHours(setMinutes(addDays(monthStart, 5), 35), 17).toISOString(),
    end_time: setHours(setMinutes(addDays(monthStart, 5), 35), 19).toISOString(),
    timezone: 'UTC',
    event_type: 'contest',
    tags: ['div1', 'div2'],
    is_online: true,
...
export const PLATFORMS_BY_CATEGORY = {
  ...
  global_competition: ['icpc', 'ioi', 'meta_hacker_cup', 'google_code_jam', 'google_kick_start'],
  hackathon: [
    'devpost',
    'mlh',
    'hackerearth',
