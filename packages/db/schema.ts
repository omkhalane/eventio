...
export const rawScrapedEvents = pgTable('raw_scraped_events', {
...
export const searchDocuments = pgTable('event_search_documents', {
  id: uuid('id').primaryKey().references(() => events.id),
  title: varchar('title').notNull(),
